		...
		$.ajax({ 
			...
			success: function(data) { 				
				// after coding
		 		...
		 		$("#FODF__ODF__ODF_").children("SPAN").text(fileSize_kb.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
		 		...
		 		$("#ID2020_12_1___101503").children("SPAN").text(data.useImage + " 개");
		 		$("#ID2020_12_2___113457").children("SPAN").text(data.useTable + " 개");
...
<div id="ODF__1">
	...
	<svg class="_1">
		<rect id="_1" rx="0" ry="0" x="0" y="0" width="1499" height="100">
		</rect>
	</svg>
	<svg class="_2">
