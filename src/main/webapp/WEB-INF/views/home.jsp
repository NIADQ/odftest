...
<body>
	<div style="width: 100%;height:100%;position:relative;background-image: url(./img/main.jpg); background-repeat: no-repeat;background-size: 100% 100%;">
		<div style="position: relative;top: 70%;padding: 0 35%;">
			<form method="post" action="odftest_manual" style="float: left;">
				<input type="submit" value="사용법  및 진단기준 상세" style="background-color: orange;color: white;border: orange;border-radius: 5px;width: 100%;height: 30px;">
			</form>
			<form method="post" action="odftest_hwp" style="float:right;">
				<input type="submit" value="진단시작" style="background-color: #00c5a1;color: white;border: #00c5a1;border-radius: 5px;width: 80px;height: 30px;">
			</form>
		</div>
	</div>
